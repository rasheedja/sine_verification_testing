...
Definition i8 := makepairF f12 f11.
Notation p13 := (BND r9 i8). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))), [1.77636e-15, 0.5]) *)
Notation p14 := (BND r10 i8). (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [1.77636e-15, 0.5]) *)
...
Notation p17 := (BND r13 i10). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [0.125, 0.1875]) *)
Notation p18 := (BND r14 i10). (* BND(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))), [0.125, 0.1875]) *)
Definition f17 := Float2 (11184811) (-26).
...
Notation p23 := (BND r18 i15). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))), [1.11022e-16, 0.03125]) *)
Notation p24 := (BND r19 i15). (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [1.11022e-16, 0.03125]) *)
Definition f24 := Float2 (1) (-7).
Definition f25 := Float2 (5) (-9).
Definition i16 := makepairF f24 f25.
Notation p25 := (BND r20 i16). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [0.0078125, 0.00976562]) *)
Notation p26 := (BND r21 i16). (* BND(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))), [0.0078125, 0.00976562]) *)
Definition f26 := Float2 (8947849) (-30).
...
Notation p31 := (BND r25 i21). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))), [1.73472e-18, 0.000488281]) *)
Notation p32 := (BND r26 i21). (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [1.73472e-18, 0.000488281]) *)
Definition f32 := Float2 (1) (-13).
Definition f33 := Float2 (7) (-15).
Definition i22 := makepairF f32 f33.
Notation p33 := (BND r27 i22). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [0.00012207, 0.000213623]) *)
Notation p34 := (BND r28 i22). (* BND(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880), [0.00012207, 0.000213623]) *)
Definition f34 := Float2 (13634817) (-36).
Definition i23 := makepairF f34 f34.
Notation p35 := (BND r29 i23). (* BND(float<24,-149,ne>(1 / 5040), [0.000198413, 0.000198413]) *)
Definition f35 := Float2 (3660068268593165) (-64).
Definition f36 := Float2 (228754266787073) (-60).
Definition i24 := makepairF f35 f36.
Notation p36 := (BND r30 i24). (* BND(1 / 5040, [0.000198413, 0.000198413]) *)
Definition f37 := Float2 (315) (4).
Definition i25 := makepairF f37 f37.
...
Qed.
Definition f38 := Float2 (54539267) (-38).
Definition i26 := makepairF f38 f34.
...
Definition f39 := Float2 (1) (-65).
Definition f40 := Float2 (1) (-14).
Definition i27 := makepairF f39 f40.
Notation p39 := (BND r32 i27). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880), [2.71051e-20, 6.10352e-05]) *)
Notation p40 := (BND r33 i27). (* BND(float<24,-149,ne>(x * x) / 362880, [2.71051e-20, 6.10352e-05]) *)
Definition f41 := Float2 (2835) (7).
Definition f42 := Float2 (1) (19).
Definition i28 := makepairF f41 f42.
...
Lemma l40 : s1 -> p41 (* BND(362880, [362880, 524288]) *).
 ...
 apply t14.
Qed.
Definition i29 := makepairF f13 f10.
Notation p42 := (BND r11 i29). (* BND(float<24,-149,ne>(x * x), [1.42109e-14, 1]) *)
Definition f43 := Float2 (1) (14).
Definition i30 := makepairF f43 f42.
...
Qed.
Definition f44 := Float2 (3) (-14).
Definition i31 := makepairF f44 f33.
Notation p44 := (BND r29 i31). (* BND(float<24,-149,ne>(1 / 5040), [0.000183105, 0.000213623]) *)
Lemma t17 : p44 -> p39 -> p34.
 intros h0 h1.
...
Notation p45 := (BND r27 i32). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [0.00012207, 0.000488281]) *)
Lemma t19 : p42 -> p45 -> p32.
 intros h0 h1.
...
Qed.
Definition f45 := Float2 (17) (-11).
Definition i33 := makepairF f45 f25.
Notation p46 := (BND r22 i33). (* BND(float<24,-149,ne>(1 / 120), [0.00830078, 0.00976562]) *)
Lemma t21 : p46 -> p31 -> p26.
 intros h0 h1.
...
Lemma l26 : s1 -> p25 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [0.0078125, 0.00976562]) *).
 ...
 apply t22. exact h1.
Qed.
Definition i34 := makepairF f24 f23.
Notation p47 := (BND r20 i34). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [0.0078125, 0.03125]) *)
Lemma t23 : p42 -> p47 -> p24.
 intros h0 h1.
...
Qed.
Definition f46 := Float2 (5) (-5).
Definition i35 := makepairF f46 f16.
Notation p48 := (BND r15 i35). (* BND(float<24,-149,ne>(1 / 6), [0.15625, 0.1875]) *)
Lemma t25 : p48 -> p23 -> p18.
 intros h0 h1.
...
Lemma l19 : s1 -> p17 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [0.125, 0.1875]) *).
 ...
 apply t26. exact h1.
Qed.
Definition i36 := makepairF f15 f11.
Notation p49 := (BND r13 i36). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [0.125, 0.5]) *)
Lemma t27 : p42 -> p49 -> p14.
 intros h0 h1.
 refine (mul_pp r11 r13 i29 i36 i8 h0 h1 _) ; finalize.
Qed.
Lemma l16 : s1 -> p14 (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [1.77636e-15, 0.5]) *).
 intros h0.
 assert (h1 := l17 h0).
 assert (h2 := l19 h0).
...
Lemma l11 : s1 -> p9 (* ABS(float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))), [0.5, 1]) *).
 ...
 apply t31. exact h1.
Qed.
Definition i37 := makepairF f1 f10.
...
Lemma l7 : s1 -> p6 (* BND(ts - x * float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))), [-2.98023e-08, 2.98023e-08]) *).
 ...
 apply t33. exact h1.
Qed.
Definition f47 := Float2 (-165979110368446155) (-82).
Definition f48 := Float2 (9) (-28).
Definition i38 := makepairF f47 f48.
Notation p51 := (BND r46 i38). (* BND(x * float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - Mts, [-3.43237e-08, 3.35276e-08]) *)
Notation r48 := ((r6 - r36)%R).
Notation r47 := ((_x * r48)%R).
Notation p52 := (BND r47 i38). (* BND(x * (float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))))), [-3.43237e-08, 3.35276e-08]) *)
Definition f49 := Float2 (-55326370122815385) (-80).
Definition f50 := Float2 (3) (-26).
Definition i39 := makepairF f49 f50.
Notation p53 := (BND r48 i39). (* BND(float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-4.57649e-08, 4.47035e-08]) *)
Notation r50 := ((r6 - r7)%R).
Notation r51 := ((r7 - r36)%R).
Notation r49 := ((r50 + r51)%R).
Notation p54 := (BND r49 i39). (* BND(float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) + (1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))))), [-4.57649e-08, 4.47035e-08]) *)
Notation p55 := (BND r50 i4). (* BND(float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))), [-2.98023e-08, 2.98023e-08]) *)
Notation p56 := (ABS r7 i6). (* ABS(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))), [0.5, 1]) *)
Lemma t34 : p11 -> p56.
 intros h0.
 refine (abs_of_bnd_p r7 i6 i6 h0 _) ; finalize.
Qed.
Lemma l46 : s1 -> p56 (* ABS(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))), [0.5, 1]) *).
 intros h0.
 assert (h1 := l13 h0).
 apply t34. exact h1.
Qed.
Lemma t35 : p56 -> p55.
 ...
 refine (float_absolute_wide_ne _ _ r7 i6 i4 h0 _) ; finalize.
Qed.
Lemma l45 : s1 -> p55 (* BND(float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))), [-2.98023e-08, 2.98023e-08]) *).
 intros h0.
 assert (h1 := l46 h0).
 apply t35. exact h1.
Qed.
Definition f51 := Float2 (-19297573103851417) (-80).
Definition f52 := Float2 (1) (-26).
Definition i40 := makepairF f51 f52.
Notation p57 := (BND r51 i40). (* BND(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-1.59626e-08, 1.49012e-08]) *)
Notation r53 := ((r9 - r37)%R).
Notation r52 := ((- r53)%R).
Notation p58 := (BND r52 i40). (* BND(-(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-1.59626e-08, 1.49012e-08]) *)
Definition f53 := Float2 (-1) (-26).
Definition f54 := Float2 (19297573103851417) (-80).
Definition i41 := makepairF f53 f54.
Notation p59 := (BND r53 i41). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-1.49012e-08, 1.59626e-08]) *)
Notation r55 := ((r9 - r10)%R).
Notation r56 := ((r10 - r37)%R).
Notation r54 := ((r55 + r56)%R).
Notation p60 := (BND r54 i41). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) + (float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-1.49012e-08, 1.59626e-08]) *)
Definition f55 := Float2 (-1) (-27).
Definition f56 := Float2 (1) (-28).
Definition i42 := makepairF f55 f56.
Notation p61 := (BND r55 i42). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [-7.45058e-09, 3.72529e-09]) *)
Definition i43 := makepairF f12 f15.
Notation p62 := (ABS r10 i43). (* ABS(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [1.77636e-15, 0.125]) *)
Notation p63 := (ABS r11 i9). (* ABS(float<24,-149,ne>(x * x), [1.42109e-14, 0.5625]) *)
Lemma t36 : p15 -> p63.
 intros h0.
 refine (abs_of_bnd_p r11 i9 i9 h0 _) ; finalize.
Qed.
Lemma l53 : s1 -> p63 (* ABS(float<24,-149,ne>(x * x), [1.42109e-14, 0.5625]) *).
 intros h0.
 assert (h1 := l17 h0).
 apply t36. exact h1.
Qed.
Notation p64 := (ABS r13 i10). (* ABS(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [0.125, 0.1875]) *)
Lemma t37 : p17 -> p64.
 intros h0.
 refine (abs_of_bnd_p r13 i10 i10 h0 _) ; finalize.
Qed.
Lemma l54 : s1 -> p64 (* ABS(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [0.125, 0.1875]) *).
 intros h0.
 assert (h1 := l19 h0).
 apply t37. exact h1.
Qed.
Definition f57 := Float2 (5) (-3).
Definition i44 := makepairF f13 f57.
Notation p65 := (ABS r11 i44). (* ABS(float<24,-149,ne>(x * x), [1.42109e-14, 0.625]) *)
Lemma t38 : p65 -> p64 -> p62.
 intros h0 h1.
 refine (mul_aa r11 r13 i44 i10 i43 h0 h1 _) ; finalize.
Qed.
Lemma l52 : s1 -> p62 (* ABS(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [1.77636e-15, 0.125]) *).
 intros h0.
 assert (h1 := l53 h0).
 assert (h2 := l54 h0).
...
Qed.
Lemma l51 : s1 -> p61 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [-7.45058e-09, 3.72529e-09]) *).
 intros h0.
 assert (h1 := l52 h0).
 apply t39. exact h1.
Qed.
Definition f58 := Float2 (14793973476480921) (-80).
Definition i45 := makepairF f55 f58.
Notation p66 := (BND r56 i45). (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-7.45058e-09, 1.22373e-08]) *)
Notation r59 := ((r13 - r38)%R).
Notation r58 := ((r11 * r59)%R).
Notation r61 := ((r11 - r12)%R).
Notation r60 := ((r61 * r38)%R).
Notation r57 := ((r58 + r60)%R).
Notation p67 := (BND r57 i45). (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))) + (float<24,-149,ne>(x * x) - x * x) * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-7.45058e-09, 1.22373e-08]) *)
Definition f59 := Float2 (-5) (-31).
Definition f60 := Float2 (35156695893281055) (-82).
Definition i46 := makepairF f59 f60.
Notation p68 := (BND r58 i46). (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-2.32831e-09, 7.27023e-09]) *)
Definition f61 := Float2 (-1) (-28).
Definition f62 := Float2 (3906299543697895) (-78).
Definition i47 := makepairF f61 f62.
Notation p69 := (BND r59 i47). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-3.72529e-09, 1.29249e-08]) *)
Notation r63 := ((r13 - r14)%R).
Notation r64 := ((r14 - r38)%R).
Notation r62 := ((r63 + r64)%R).
Notation p70 := (BND r62 i47). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) + (float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-3.72529e-09, 1.29249e-08]) *)
Definition f63 := Float2 (1) (-27).
Definition i48 := makepairF f55 f63.
Notation p71 := (BND r63 i48). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [-7.45058e-09, 7.45058e-09]) *)
Definition f64 := Float2 (1) (-2).
Definition i49 := makepairF f15 f64.
Notation p72 := (ABS r14 i49). (* ABS(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))), [0.125, 0.25]) *)
Notation p73 := (BND r14 i49). (* BND(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))), [0.125, 0.25]) *)
Lemma t40 : p73 -> p72.
 intros h0.
 refine (abs_of_bnd_p r14 i49 i49 h0 _) ; finalize.
Qed.
Lemma l61 : s1 -> p72 (* ABS(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))), [0.125, 0.25]) *).
 intros h0.
 assert (h1 := l20 h0).
...
Qed.
Lemma l60 : s1 -> p71 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))), [-7.45058e-09, 7.45058e-09]) *).
 intros h0.
 assert (h1 := l61 h0).
 apply t41. exact h1.
Qed.
Definition f65 := Float2 (1654499730012647) (-78).
Definition i50 := makepairF f56 f65.
Notation p74 := (BND r64 i50). (* BND(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [3.72529e-09, 5.47428e-09]) *)
Notation r66 := ((r15 - r16)%R).
Notation r67 := ((r18 - r39)%R).
Notation r65 := ((r66 - r67)%R).
Notation p75 := (BND r65 i50). (* BND(float<24,-149,ne>(1 / 6) - 1 / 6 - (float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [3.72529e-09, 5.47428e-09]) *)
Definition f66 := Float2 (21) (-32).
Definition f67 := Float2 (11453246123) (-61).
Definition i51 := makepairF f66 f67.
Notation p76 := (BND r66 i51). (* BND(float<24,-149,ne>(1 / 6) - 1 / 6, [4.88944e-09, 4.96705e-09]) *)
Definition f68 := Float2 (715827883) (-32).
Definition i52 := makepairF f18 f68.
Notation p77 := (BND r16 i52). (* BND(1 / 6, [0.166667, 0.166667]) *)
Lemma t42 : p19 -> p77 -> p76.
 intros h0 h1.
 refine (sub r15 r16 i11 i52 i51 h0 h1 _) ; finalize.
Qed.
Lemma l64 : s1 -> p76 (* BND(float<24,-149,ne>(1 / 6) - 1 / 6, [4.88944e-09, 4.96705e-09]) *).
 intros h0.
 assert (h1 := l21 h0).
 assert (h2 := l22 h0).
 apply t42. exact h1. refine (subset r16 i12 i52 h2 _) ; finalize.
Qed.
Definition f69 := Float2 (-153299854178791) (-78).
Definition f70 := Float2 (5) (-32).
Definition i53 := makepairF f69 f70.
Notation p78 := (BND r67 i53). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-5.07227e-10, 1.16415e-09]) *)
Notation r69 := ((r18 - r19)%R).
Notation r70 := ((r19 - r39)%R).
Notation r68 := ((r69 + r70)%R).
Notation p79 := (BND r68 i53). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) + (float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-5.07227e-10, 1.16415e-09]) *)
Definition f71 := Float2 (-1) (-32).
Definition f72 := Float2 (1) (-32).
Definition i54 := makepairF f71 f72.
Notation p80 := (BND r69 i54). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [-2.32831e-10, 2.32831e-10]) *)
Definition i55 := makepairF f22 f24.
Notation p81 := (ABS r19 i55). (* ABS(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [1.11022e-16, 0.0078125]) *)
Notation p82 := (ABS r20 i16). (* ABS(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [0.0078125, 0.00976562]) *)
Lemma t43 : p25 -> p82.
 intros h0.
 refine (abs_of_bnd_p r20 i16 i16 h0 _) ; finalize.
Qed.
Lemma l69 : s1 -> p82 (* ABS(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [0.0078125, 0.00976562]) *).
 intros h0.
 assert (h1 := l26 h0).
 apply t43. exact h1.
Qed.
Definition i56 := makepairF f13 f2.
Notation p83 := (ABS r11 i56). (* ABS(float<24,-149,ne>(x * x), [1.42109e-14, 0.75]) *)
Lemma t44 : p83 -> p82 -> p81.
 intros h0 h1.
 refine (mul_aa r11 r20 i56 i16 i55 h0 h1 _) ; finalize.
Qed.
Lemma l68 : s1 -> p81 (* ABS(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [1.11022e-16, 0.0078125]) *).
 intros h0.
 assert (h1 := l53 h0).
 assert (h2 := l69 h0).
 apply t44. refine (abs_subset r11 i9 i56 h1 _) ; finalize. exact h2.
Qed.
Lemma t45 : p81 -> p80.
 intros h0.
 refine (float_absolute_wide_ne _ _ r19 i55 i54 h0 _) ; finalize.
Qed.
Lemma l67 : s1 -> p80 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [-2.32831e-10, 2.32831e-10]) *).
 intros h0.
 assert (h1 := l68 h0).
 apply t45. exact h1.
Qed.
Definition f73 := Float2 (-82931110001127) (-78).
Definition f74 := Float2 (1) (-30).
Definition i57 := makepairF f73 f74.
Notation p84 := (BND r70 i57). (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-2.74396e-10, 9.31323e-10]) *)
Notation r73 := ((r20 - r40)%R).
Notation r72 := ((r11 * r73)%R).
Notation r74 := ((r61 * r40)%R).
Notation r71 := ((r72 + r74)%R).
Notation p85 := (BND r71 i57). (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880))) + (float<24,-149,ne>(x * x) - x * x) * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-2.74396e-10, 9.31323e-10]) *)
Definition f75 := Float2 (-31484464846475) (-80).
Definition f76 := Float2 (5) (-33).
Definition i58 := makepairF f75 f76.
Notation p86 := (BND r72 i58). (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-2.60433e-11, 5.82077e-10]) *)
Definition f77 := Float2 (-447779055594311) (-83).
Definition i59 := makepairF f77 f74.
Notation p87 := (BND r73 i59). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-4.62993e-11, 9.31323e-10]) *)
Notation r76 := ((r20 - r21)%R).
Notation r77 := ((r21 - r40)%R).
Notation r75 := ((r76 + r77)%R).
Notation p88 := (BND r75 i59). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) + (float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-4.62993e-11, 9.31323e-10]) *)
Definition f78 := Float2 (-1) (-31).
Definition f79 := Float2 (1) (-31).
Definition i60 := makepairF f78 f79.
Notation p89 := (BND r76 i60). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [-4.65661e-10, 4.65661e-10]) *)
Definition f80 := Float2 (1) (-6).
Definition i61 := makepairF f24 f80.
Notation p90 := (ABS r21 i61). (* ABS(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))), [0.0078125, 0.015625]) *)
Notation p91 := (BND r21 i61). (* BND(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))), [0.0078125, 0.015625]) *)
Lemma t46 : p91 -> p90.
 intros h0.
 refine (abs_of_bnd_p r21 i61 i61 h0 _) ; finalize.
Qed.
Lemma l76 : s1 -> p90 (* ABS(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))), [0.0078125, 0.015625]) *).
 intros h0.
 assert (h1 := l27 h0).
 apply t46. refine (subset r21 i16 i61 h1 _) ; finalize.
Qed.
Lemma t47 : p90 -> p89.
 intros h0.
 refine (float_absolute_wide_ne _ _ r21 i61 i60 h0 _) ; finalize.
Qed.
Lemma l75 : s1 -> p89 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))), [-4.65661e-10, 4.65661e-10]) *).
 intros h0.
 assert (h1 := l76 h0).
 apply t47. exact h1.
Qed.
Definition f81 := Float2 (4055820571776185) (-83).
Definition i62 := makepairF f81 f79.
Notation p92 := (BND r77 i62). (* BND(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [4.19362e-10, 4.65661e-10]) *)
Notation r79 := ((r22 - r23)%R).
Notation r80 := ((r25 - r41)%R).
Notation r78 := ((r79 - r80)%R).
Notation p93 := (BND r78 i62). (* BND(float<24,-149,ne>(1 / 120) - 1 / 120 - (float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - x * x * (1 / 5040 - x * x / 362880)), [4.19362e-10, 4.65661e-10]) *)
Definition f82 := Float2 (32069089143) (-66).
Definition f83 := Float2 (15) (-35).
Definition i63 := makepairF f82 f83.
Notation p94 := (BND r79 i63). (* BND(float<24,-149,ne>(1 / 120) - 1 / 120, [4.34617e-10, 4.36557e-10]) *)
Lemma t48 : p27 -> p28 -> p94.
 intros h0 h1.
 refine (sub r22 r23 i17 i18 i63 h0 h1 _) ; finalize.
Qed.
Lemma l79 : s1 -> p94 (* BND(float<24,-149,ne>(1 / 120) - 1 / 120, [4.34617e-10, 4.36557e-10]) *).
 intros h0.
 assert (h1 := l28 h0).
 assert (h2 := l29 h0).
...
Definition f84 := Float2 (-1) (-35).
Definition f85 := Float2 (147539080375111) (-83).
Definition i64 := makepairF f84 f85.
Notation p95 := (BND r80 i64). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - x * x * (1 / 5040 - x * x / 362880), [-2.91038e-11, 1.52552e-11]) *)
Notation r82 := ((r25 - r26)%R).
Notation r83 := ((r26 - r41)%R).
Notation r81 := ((r82 + r83)%R).
Notation p96 := (BND r81 i64). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) + (float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - x * x * (1 / 5040 - x * x / 362880)), [-2.91038e-11, 1.52552e-11]) *)
Definition f86 := Float2 (-1) (-36).
Definition f87 := Float2 (1) (-38).
Definition i65 := makepairF f86 f87.
Notation p97 := (BND r82 i65). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [-1.45519e-11, 3.63798e-12]) *)
Definition i66 := makepairF f30 f32.
Notation p98 := (ABS r26 i66). (* ABS(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [1.73472e-18, 0.00012207]) *)
Notation p99 := (ABS r27 i22). (* ABS(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [0.00012207, 0.000213623]) *)
Lemma t49 : p33 -> p99.
 intros h0.
 refine (abs_of_bnd_p r27 i22 i22 h0 _) ; finalize.
Qed.
Lemma l84 : s1 -> p99 (* ABS(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [0.00012207, 0.000213623]) *).
 intros h0.
 assert (h1 := l33 h0).
 apply t49. exact h1.
Qed.
Lemma t50 : p63 -> p99 -> p98.
 intros h0 h1.
 refine (mul_aa r11 r27 i9 i22 i66 h0 h1 _) ; finalize.
Qed.
Lemma l83 : s1 -> p98 (* ABS(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [1.73472e-18, 0.00012207]) *).
 intros h0.
 assert (h1 := l53 h0).
 assert (h2 := l84 h0).
...
Lemma t51 : p98 -> p97.
 intros h0.
 refine (float_absolute_wide_ne _ _ r26 i66 i65 h0 _) ; finalize.
Qed.
Lemma l82 : s1 -> p97 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [-1.45519e-11, 3.63798e-12]) *).
 intros h0.
 assert (h1 := l83 h0).
 apply t51. exact h1.
Qed.
Definition f88 := Float2 (112354708286279) (-83).
Definition i67 := makepairF f86 f88.
Notation p100 := (BND r83 i67). (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - x * x * (1 / 5040 - x * x / 362880), [-1.45519e-11, 1.16172e-11]) *)
Notation r86 := ((r27 - r42)%R).
Notation r85 := ((r11 * r86)%R).
Notation r87 := ((r61 * r42)%R).
Notation r84 := ((r85 + r87)%R).
Notation p101 := (BND r84 i67). (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (1 / 5040 - x * x / 362880)) + (float<24,-149,ne>(x * x) - x * x) * (1 / 5040 - x * x / 362880), [-1.45519e-11, 1.16172e-11]) *)
Definition f89 := Float2 (-1) (-37).
Definition f90 := Float2 (220664566358043) (-85).
Definition i68 := makepairF f89 f90.
Notation p102 := (BND r85 i68). (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (1 / 5040 - x * x / 362880)), [-7.27596e-12, 5.70405e-12]) *)
Definition f91 := Float2 (196146281207149) (-84).
Definition i69 := makepairF f89 f91.
Notation p103 := (BND r86 i69). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (1 / 5040 - x * x / 362880), [-7.27596e-12, 1.01405e-11]) *)
Notation r89 := ((r27 - r28)%R).
Notation r90 := ((r28 - r42)%R).
Notation r88 := ((r89 + r90)%R).
Notation p104 := (BND r88 i69). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) + (float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - (1 / 5040 - x * x / 362880)), [-7.27596e-12, 1.01405e-11]) *)
Definition f92 := Float2 (1) (-37).
Definition i70 := makepairF f89 f92.
Notation p105 := (BND r89 i70). (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [-7.27596e-12, 7.27596e-12]) *)
Definition f93 := Float2 (1) (-12).
Definition i71 := makepairF f32 f93.
Notation p106 := (ABS r28 i71). (* ABS(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880), [0.00012207, 0.000244141]) *)
Notation p107 := (BND r28 i71). (* BND(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880), [0.00012207, 0.000244141]) *)
Lemma t52 : p107 -> p106.
 intros h0.
 refine (abs_of_bnd_p r28 i71 i71 h0 _) ; finalize.
Qed.
Lemma l91 : s1 -> p106 (* ABS(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880), [0.00012207, 0.000244141]) *).
 intros h0.
 assert (h1 := l34 h0).
 apply t52. refine (subset r28 i22 i71 h1 _) ; finalize.
Qed.
Lemma t53 : p106 -> p105.
 intros h0.
 refine (float_absolute_wide_ne _ _ r28 i71 i70 h0 _) ; finalize.
Qed.
Lemma l90 : s1 -> p105 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)), [-7.27596e-12, 7.27596e-12]) *).
 intros h0.
 assert (h1 := l91 h0).
 apply t53. exact h1.
Qed.
Definition f94 := Float2 (1) (-39).
Definition f95 := Float2 (55408792851821) (-84).
Definition i72 := makepairF f94 f95.
Notation p108 := (BND r90 i72). (* BND(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - (1 / 5040 - x * x / 362880), [1.81899e-12, 2.86457e-12]) *)
Notation r92 := ((r29 - r30)%R).
Notation r93 := ((r32 - r43)%R).
Notation r91 := ((r92 - r93)%R).
Notation p109 := (BND r91 i72). (* BND(float<24,-149,ne>(1 / 5040) - 1 / 5040 - (float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - x * x / 362880), [1.81899e-12, 2.86457e-12]) *)
Definition f96 := Float2 (5) (-41).
Definition f97 := Float2 (50278387) (-64).
Definition i73 := makepairF f96 f97.
Notation p110 := (BND r92 i73). (* BND(float<24,-149,ne>(1 / 5040) - 1 / 5040, [2.27374e-12, 2.7256e-12]) *)
Definition f98 := Float2 (436314139) (-41).
Definition i74 := makepairF f35 f98.
Notation p111 := (BND r30 i74). (* BND(1 / 5040, [0.000198413, 0.000198413]) *)
Lemma t54 : p35 -> p111 -> p110.
 intros h0 h1.
 refine (sub r29 r30 i23 i74 i73 h0 h1 _) ; finalize.
Qed.
Lemma l94 : s1 -> p110 (* BND(float<24,-149,ne>(1 / 5040) - 1 / 5040, [2.27374e-12, 2.7256e-12]) *).
 intros h0.
 assert (h1 := l35 h0).
 assert (h2 := l36 h0).
 apply t54. exact h1. refine (subset r30 i24 i74 h2 _) ; finalize.
Qed.
Definition f99 := Float2 (-2688082924909) (-84).
Definition f100 := Float2 (1) (-41).
Definition i75 := makepairF f99 f100.
Notation p112 := (BND r93 i75). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - x * x / 362880, [-1.38971e-13, 4.54747e-13]) *)
Notation r95 := ((r32 - r33)%R).
Notation r96 := ((r33 - r43)%R).
Notation r94 := ((r95 + r96)%R).
Notation p113 := (BND r94 i75). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - float<24,-149,ne>(x * x) / 362880 + (float<24,-149,ne>(x * x) / 362880 - x * x / 362880), [-1.38971e-13, 4.54747e-13]) *)
Definition f101 := Float2 (-1) (-44).
Definition f102 := Float2 (1) (-42).
Definition i76 := makepairF f101 f102.
Notation p114 := (BND r95 i76). (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - float<24,-149,ne>(x * x) / 362880, [-5.68434e-14, 2.27374e-13]) *)
Definition f103 := Float2 (1) (-19).
Definition i77 := makepairF f39 f103.
Notation p115 := (ABS r33 i77). (* ABS(float<24,-149,ne>(x * x) / 362880, [2.71051e-20, 1.90735e-06]) *)
Definition f104 := Float2 (5) (16).
Definition i78 := makepairF f104 f42.
Notation p116 := (ABS r34 i78). (* ABS(362880, [327680, 524288]) *)
Notation p117 := (BND r34 i78). (* BND(362880, [327680, 524288]) *)
Lemma t55 : p117 -> p116.
 intros h0.
 refine (abs_of_bnd_p r34 i78 i78 h0 _) ; finalize.
Qed.
Lemma l99 : s1 -> p116 (* ABS(362880, [327680, 524288]) *).
 intros h0.
 assert (h1 := l40 h0).
 apply t55. refine (subset r34 i28 i78 h1 _) ; finalize.
Qed.
Lemma t56 : p65 -> p116 -> p115.
 intros h0 h1.
 refine (div_aa r11 r34 i44 i78 i77 h0 h1 _) ; finalize.
Qed.
Lemma l98 : s1 -> p115 (* ABS(float<24,-149,ne>(x * x) / 362880, [2.71051e-20, 1.90735e-06]) *).
 intros h0.
 assert (h1 := l53 h0).
 assert (h2 := l99 h0).
 apply t56. refine (abs_subset r11 i9 i44 h1 _) ; finalize. exact h2.
Qed.
Lemma t57 : p115 -> p114.
 intros h0.
 refine (float_absolute_wide_ne _ _ r33 i77 i76 h0 _) ; finalize.
Qed.
Lemma l97 : s1 -> p114 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - float<24,-149,ne>(x * x) / 362880, [-5.68434e-14, 2.27374e-13]) *).
 intros h0.
 assert (h1 := l98 h0).
 apply t57. exact h1.
Qed.
Definition f105 := Float2 (-1588571297133) (-84).
Definition i79 := makepairF f105 f102.
Notation p118 := (BND r96 i79). (* BND(float<24,-149,ne>(x * x) / 362880 - x * x / 362880, [-8.21272e-14, 2.27374e-13]) *)
Notation p119 := (NZR r34). (* NZR(362880) *)
Definition i80 := makepairF f10 f42.
Notation p120 := (ABS r34 i80). (* ABS(362880, [1, 524288]) *)
Lemma t58 : p120 -> p119.
 intros h0.
 refine (nzr_of_abs r34 i80 h0 _) ; finalize.
Qed.
Lemma l101 : s1 -> p119 (* NZR(362880) *).
 intros h0.
 assert (h1 := l99 h0).
 apply t58. refine (abs_subset r34 i78 i80 h1 _) ; finalize.
Qed.
Notation r97 := ((r61 / r34)%R).
Notation p121 := (BND r97 i79). (* BND((float<24,-149,ne>(x * x) - x * x) / 362880, [-8.21272e-14, 2.27374e-13]) *)
Notation p122 := (BND r61 i4). (* BND(float<24,-149,ne>(x * x) - x * x, [-2.98023e-08, 2.98023e-08]) *)
Notation p123 := (ABS r12 i29). (* ABS(x * x, [1.42109e-14, 1]) *)
Lemma t59 : p50 -> p50 -> p123.
 intros h0 h1.
 refine (mul_aa _x _x i37 i37 i29 h0 h1 _) ; finalize.
Qed.
Lemma l104 : s1 -> p123 (* ABS(x * x, [1.42109e-14, 1]) *).
 intros h0.
 assert (h1 := l9 h0).
...
Qed.
Lemma l103 : s1 -> p122 (* BND(float<24,-149,ne>(x * x) - x * x, [-2.98023e-08, 2.98023e-08]) *).
 intros h0.
 assert (h1 := l104 h0).
 apply t60. exact h1.
Qed.
Definition i81 := makepairF f7 f9.
Notation p124 := (BND r61 i81). (* BND(float<24,-149,ne>(x * x) - x * x, [-2.98023e-08, 5.96046e-08]) *)
Lemma t61 : p124 -> p41 -> p121.
 intros h0 h1.
 refine (div_op r61 r34 i81 i28 i79 h0 h1 _) ; finalize.
Qed.
Lemma l102 : s1 -> p121 (* BND((float<24,-149,ne>(x * x) - x * x) / 362880, [-8.21272e-14, 2.27374e-13]) *).
 intros h0.
 assert (h1 := l103 h0).
 assert (h2 := l40 h0).
 apply t61. refine (subset r61 i4 i81 h1 _) ; finalize. exact h2.
Qed.
Lemma t62 : p119 -> p121 -> p118.
 intros h0 h1.
 refine (div_firs _ r34 _ i79 h0 h1) ; finalize.
Qed.
Lemma l100 : s1 -> p118 (* BND(float<24,-149,ne>(x * x) / 362880 - x * x / 362880, [-8.21272e-14, 2.27374e-13]) *).
 intros h0.
 assert (h1 := l101 h0).
 assert (h2 := l102 h0).
 apply t62. exact h1. exact h2.
Qed.
Lemma t63 : p114 -> p118 -> p113.
 intros h0 h1.
 refine (add r95 r96 i76 i79 i75 h0 h1 _) ; finalize.
Qed.
Lemma l96 : s1 -> p113 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - float<24,-149,ne>(x * x) / 362880 + (float<24,-149,ne>(x * x) / 362880 - x * x / 362880), [-1.38971e-13, 4.54747e-13]) *).
 intros h0.
 assert (h1 := l97 h0).
 assert (h2 := l100 h0).
...
Lemma t64 : p113 -> p112.
 intros h0.
 refine (sub_xals _ _ _ i75 h0) ; finalize.
Qed.
Lemma l95 : s1 -> p112 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - x * x / 362880, [-1.38971e-13, 4.54747e-13]) *).
 intros h0.
 assert (h1 := l96 h0).
 apply t64. exact h1.
Qed.
Lemma t65 : p110 -> p112 -> p109.
 intros h0 h1.
 refine (sub r92 r93 i73 i75 i72 h0 h1 _) ; finalize.
Qed.
Lemma l93 : s1 -> p109 (* BND(float<24,-149,ne>(1 / 5040) - 1 / 5040 - (float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - x * x / 362880), [1.81899e-12, 2.86457e-12]) *).
 intros h0.
 assert (h1 := l94 h0).
 assert (h2 := l95 h0).
...
Lemma t66 : p109 -> p108.
 intros h0.
 refine (sub_mibs _ _ _ _ i72 h0) ; finalize.
Qed.
Lemma l92 : s1 -> p108 (* BND(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - (1 / 5040 - x * x / 362880), [1.81899e-12, 2.86457e-12]) *).
 intros h0.
 assert (h1 := l93 h0).
 apply t66. exact h1.
Qed.
Lemma t67 : p105 -> p108 -> p104.
 intros h0 h1.
 refine (add r89 r90 i70 i72 i69 h0 h1 _) ; finalize.
Qed.
Lemma l89 : s1 -> p104 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) + (float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880) - (1 / 5040 - x * x / 362880)), [-7.27596e-12, 1.01405e-11]) *).
 intros h0.
 assert (h1 := l90 h0).
 assert (h2 := l92 h0).
...
Lemma t68 : p104 -> p103.
 intros h0.
 refine (sub_xals _ _ _ i69 h0) ; finalize.
Qed.
Lemma l88 : s1 -> p103 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (1 / 5040 - x * x / 362880), [-7.27596e-12, 1.01405e-11]) *).
 intros h0.
 assert (h1 := l89 h0).
 apply t68. exact h1.
Qed.
Lemma t69 : p15 -> p103 -> p102.
 intros h0 h1.
 refine (mul_po r11 r86 i9 i69 i68 h0 h1 _) ; finalize.
Qed.
Lemma l87 : s1 -> p102 (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (1 / 5040 - x * x / 362880)), [-7.27596e-12, 5.70405e-12]) *).
 intros h0.
 assert (h1 := l17 h0).
 assert (h2 := l88 h0).
...
Qed.
Definition f106 := Float2 (228754266787073) (-85).
Definition i82 := makepairF f89 f106.
Notation p125 := (BND r87 i82). (* BND((float<24,-149,ne>(x * x) - x * x) * (1 / 5040 - x * x / 362880), [-7.27596e-12, 5.91316e-12]) *)
Definition i83 := makepairF f44 f36.
Notation p126 := (BND r42 i83). (* BND(1 / 5040 - x * x / 362880, [0.000183105, 0.000198413]) *)
Definition f107 := Float2 (1) (-16).
Definition i84 := makepairF f39 f107.
Notation p127 := (BND r43 i84). (* BND(x * x / 362880, [2.71051e-20, 1.52588e-05]) *)
Notation p128 := (BND r12 i29). (* BND(x * x, [1.42109e-14, 1]) *)
Definition f108 := Float2 (1) (16).
Definition i85 := makepairF f108 f42.
Notation p129 := (BND r34 i85). (* BND(362880, [65536, 524288]) *)
Lemma t70 : p128 -> p129 -> p127.
 intros h0 h1.
 refine (div_pp r12 r34 i29 i85 i84 h0 h1 _) ; finalize.
Qed.
Lemma l107 : s1 -> p127 (* BND(x * x / 362880, [2.71051e-20, 1.52588e-05]) *).
 intros h0.
 assert (h1 := l18 h0).
 assert (h2 := l40 h0).
 apply t70. refine (subset r12 i9 i29 h1 _) ; finalize. refine (subset r34 i28 i85 h2 _) ; finalize.
Qed.
Definition f109 := Float2 (13) (-16).
Definition i86 := makepairF f109 f36.
Notation p130 := (BND r30 i86). (* BND(1 / 5040, [0.000198364, 0.000198413]) *)
Lemma t71 : p130 -> p127 -> p126.
 intros h0 h1.
 refine (sub r30 r43 i86 i84 i83 h0 h1 _) ; finalize.
Qed.
Lemma l106 : s1 -> p126 (* BND(1 / 5040 - x * x / 362880, [0.000183105, 0.000198413]) *).
 intros h0.
 assert (h1 := l36 h0).
 assert (h2 := l107 h0).
 apply t71. refine (subset r30 i24 i86 h1 _) ; finalize. exact h2.
Qed.
Definition i87 := makepairF f32 f36.
Notation p131 := (BND r42 i87). (* BND(1 / 5040 - x * x / 362880, [0.00012207, 0.000198413]) *)
Lemma t72 : p122 -> p131 -> p125.
 intros h0 h1.
 refine (mul_op r61 r42 i4 i87 i82 h0 h1 _) ; finalize.
Qed.
Lemma l105 : s1 -> p125 (* BND((float<24,-149,ne>(x * x) - x * x) * (1 / 5040 - x * x / 362880), [-7.27596e-12, 5.91316e-12]) *).
 intros h0.
 assert (h1 := l103 h0).
 assert (h2 := l106 h0).
 apply t72. exact h1. refine (subset r42 i83 i87 h2 _) ; finalize.
Qed.
Lemma t73 : p102 -> p125 -> p101.
 intros h0 h1.
 refine (add r85 r87 i68 i82 i67 h0 h1 _) ; finalize.
Qed.
Lemma l86 : s1 -> p101 (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - (1 / 5040 - x * x / 362880)) + (float<24,-149,ne>(x * x) - x * x) * (1 / 5040 - x * x / 362880), [-1.45519e-11, 1.16172e-11]) *).
 intros h0.
 assert (h1 := l87 h0).
 assert (h2 := l105 h0).
...
Lemma t74 : p101 -> p100.
 intros h0.
 refine (mul_mars _ _ _ _ i67 h0) ; finalize.
Qed.
Lemma l85 : s1 -> p100 (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - x * x * (1 / 5040 - x * x / 362880), [-1.45519e-11, 1.16172e-11]) *).
 intros h0.
 assert (h1 := l86 h0).
 apply t74. exact h1.
Qed.
Lemma t75 : p97 -> p100 -> p96.
 intros h0 h1.
 refine (add r82 r83 i65 i67 i64 h0 h1 _) ; finalize.
Qed.
Lemma l81 : s1 -> p96 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) + (float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)) - x * x * (1 / 5040 - x * x / 362880)), [-2.91038e-11, 1.52552e-11]) *).
 intros h0.
 assert (h1 := l82 h0).
 assert (h2 := l85 h0).
...
Lemma t76 : p96 -> p95.
 intros h0.
 refine (sub_xals _ _ _ i64 h0) ; finalize.
Qed.
Lemma l80 : s1 -> p95 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - x * x * (1 / 5040 - x * x / 362880), [-2.91038e-11, 1.52552e-11]) *).
 intros h0.
 assert (h1 := l81 h0).
 apply t76. exact h1.
Qed.
Lemma t77 : p94 -> p95 -> p93.
 intros h0 h1.
 refine (sub r79 r80 i63 i64 i62 h0 h1 _) ; finalize.
Qed.
Lemma l78 : s1 -> p93 (* BND(float<24,-149,ne>(1 / 120) - 1 / 120 - (float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - x * x * (1 / 5040 - x * x / 362880)), [4.19362e-10, 4.65661e-10]) *).
 intros h0.
 assert (h1 := l79 h0).
 assert (h2 := l80 h0).
...
Lemma t78 : p93 -> p92.
 intros h0.
 refine (sub_mibs _ _ _ _ i62 h0) ; finalize.
Qed.
Lemma l77 : s1 -> p92 (* BND(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [4.19362e-10, 4.65661e-10]) *).
 intros h0.
 assert (h1 := l78 h0).
 apply t78. exact h1.
Qed.
Lemma t79 : p89 -> p92 -> p88.
 intros h0 h1.
 refine (add r76 r77 i60 i62 i59 h0 h1 _) ; finalize.
Qed.
Lemma l74 : s1 -> p88 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) + (float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-4.62993e-11, 9.31323e-10]) *).
 intros h0.
 assert (h1 := l75 h0).
 assert (h2 := l77 h0).
...
Qed.
Lemma l73 : s1 -> p87 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-4.62993e-11, 9.31323e-10]) *).
 intros h0.
 assert (h1 := l74 h0).
 apply t80. exact h1.
Qed.
Lemma t81 : p15 -> p87 -> p86.
 intros h0 h1.
 refine (mul_po r11 r73 i9 i59 i58 h0 h1 _) ; finalize.
Qed.
Lemma l72 : s1 -> p86 (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-2.60433e-11, 5.82077e-10]) *).
 intros h0.
 assert (h1 := l17 h0).
 assert (h2 := l73 h0).
...
Definition f110 := Float2 (-300239975158033) (-80).
Definition f111 := Float2 (3) (-33).
Definition i88 := makepairF f110 f111.
Notation p132 := (BND r74 i88). (* BND((float<24,-149,ne>(x * x) - x * x) * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-2.48353e-10, 3.49246e-10]) *)
Definition f112 := Float2 (33) (-12).
Definition f113 := Float2 (300239975158033) (-55).
Definition i89 := makepairF f112 f113.
Notation p133 := (BND r40 i89). (* BND(1 / 120 - x * x * (1 / 5040 - x * x / 362880), [0.00805664, 0.00833333]) *)
Definition f114 := Float2 (3) (-60).
Definition i90 := makepairF f114 f93.
Notation p134 := (BND r41 i90). (* BND(x * x * (1 / 5040 - x * x / 362880), [2.60209e-18, 0.000244141]) *)
Definition i91 := makepairF f44 f93.
Notation p135 := (BND r42 i91). (* BND(1 / 5040 - x * x / 362880, [0.000183105, 0.000244141]) *)
Lemma t82 : p128 -> p135 -> p134.
 intros h0 h1.
 refine (mul_pp r12 r42 i29 i91 i90 h0 h1 _) ; finalize.
Qed.
Lemma l110 : s1 -> p134 (* BND(x * x * (1 / 5040 - x * x / 362880), [2.60209e-18, 0.000244141]) *).
 intros h0.
 assert (h1 := l18 h0).
 assert (h2 := l106 h0).
 apply t82. refine (subset r12 i9 i29 h1 _) ; finalize. refine (subset r42 i83 i91 h2 _) ; finalize.
Qed.
Definition f115 := Float2 (9607679205057059) (-60).
Definition i92 := makepairF f45 f115.
Notation p136 := (BND r23 i92). (* BND(1 / 120, [0.00830078, 0.00833333]) *)
Lemma t83 : p136 -> p134 -> p133.
 intros h0 h1.
 refine (sub r23 r41 i92 i90 i89 h0 h1 _) ; finalize.
Qed.
Lemma l109 : s1 -> p133 (* BND(1 / 120 - x * x * (1 / 5040 - x * x / 362880), [0.00805664, 0.00833333]) *).
 intros h0.
 assert (h1 := l29 h0).
 assert (h2 := l110 h0).
 apply t83. refine (subset r23 i18 i92 h1 _) ; finalize. exact h2.
Qed.
Definition i93 := makepairF f24 f113.
Notation p137 := (BND r40 i93). (* BND(1 / 120 - x * x * (1 / 5040 - x * x / 362880), [0.0078125, 0.00833333]) *)
Lemma t84 : p122 -> p137 -> p132.
 intros h0 h1.
 refine (mul_op r61 r40 i4 i93 i88 h0 h1 _) ; finalize.
Qed.
Lemma l108 : s1 -> p132 (* BND((float<24,-149,ne>(x * x) - x * x) * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-2.48353e-10, 3.49246e-10]) *).
 intros h0.
 assert (h1 := l103 h0).
 assert (h2 := l109 h0).
 apply t84. exact h1. refine (subset r40 i89 i93 h2 _) ; finalize.
Qed.
Lemma t85 : p86 -> p132 -> p85.
 intros h0 h1.
 refine (add r72 r74 i58 i88 i57 h0 h1 _) ; finalize.
Qed.
Lemma l71 : s1 -> p85 (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - (1 / 120 - x * x * (1 / 5040 - x * x / 362880))) + (float<24,-149,ne>(x * x) - x * x) * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-2.74396e-10, 9.31323e-10]) *).
 intros h0.
 assert (h1 := l72 h0).
 assert (h2 := l108 h0).
...
Lemma t86 : p85 -> p84.
 intros h0.
 refine (mul_mars _ _ _ _ i57 h0) ; finalize.
Qed.
Lemma l70 : s1 -> p84 (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-2.74396e-10, 9.31323e-10]) *).
 intros h0.
 assert (h1 := l71 h0).
 apply t86. exact h1.
Qed.
Lemma t87 : p80 -> p84 -> p79.
 intros h0 h1.
 refine (add r69 r70 i54 i57 i53 h0 h1 _) ; finalize.
Qed.
Lemma l66 : s1 -> p79 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) + (float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-5.07227e-10, 1.16415e-09]) *).
 intros h0.
 assert (h1 := l67 h0).
 assert (h2 := l70 h0).
...
Qed.
Lemma l65 : s1 -> p78 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [-5.07227e-10, 1.16415e-09]) *).
 intros h0.
 assert (h1 := l66 h0).
 apply t88. exact h1.
Qed.
Lemma t89 : p76 -> p78 -> p75.
 intros h0 h1.
 refine (sub r66 r67 i51 i53 i50 h0 h1 _) ; finalize.
Qed.
Lemma l63 : s1 -> p75 (* BND(float<24,-149,ne>(1 / 6) - 1 / 6 - (float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [3.72529e-09, 5.47428e-09]) *).
 intros h0.
 assert (h1 := l64 h0).
 assert (h2 := l65 h0).
...
Qed.
Lemma l62 : s1 -> p74 (* BND(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [3.72529e-09, 5.47428e-09]) *).
 intros h0.
 assert (h1 := l63 h0).
 apply t90. exact h1.
Qed.
...
Qed.
Lemma l59 : s1 -> p70 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) + (float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-3.72529e-09, 1.29249e-08]) *).
 intros h0.
 assert (h1 := l60 h0).
 assert (h2 := l62 h0).
...
Qed.
Lemma l58 : s1 -> p69 (* BND(float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-3.72529e-09, 1.29249e-08]) *).
 intros h0.
 assert (h1 := l59 h0).
 apply t92. exact h1.
Qed.
...
Qed.
Lemma l57 : s1 -> p68 (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-2.32831e-09, 7.27023e-09]) *).
 intros h0.
 assert (h1 := l17 h0).
 assert (h2 := l58 h0).
...
Definition f116 := Float2 (-11) (-31).
Definition f117 := Float2 (24019198012642629) (-82).
Definition i94 := makepairF f116 f117.
Notation p138 := (BND r60 i94). (* BND((float<24,-149,ne>(x * x) - x * x) * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-5.12227e-09, 4.96705e-09]) *)
Definition f118 := Float2 (24019198012642629) (-57).
Definition i95 := makepairF f15 f118.
Notation p139 := (BND r38 i95). (* BND(1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [0.125, 0.166667]) *)
Definition f119 := Float2 (33) (-58).
Definition i96 := makepairF f119 f23.
Notation p140 := (BND r39 i96). (* BND(x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [1.14492e-16, 0.03125]) *)
Definition i97 := makepairF f112 f23.
Notation p141 := (BND r40 i97). (* BND(1 / 120 - x * x * (1 / 5040 - x * x / 362880), [0.00805664, 0.03125]) *)
Lemma t94 : p128 -> p141 -> p140.
 intros h0 h1.
 refine (mul_pp r12 r40 i29 i97 i96 h0 h1 _) ; finalize.
Qed.
Lemma l113 : s1 -> p140 (* BND(x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [1.14492e-16, 0.03125]) *).
 intros h0.
 assert (h1 := l18 h0).
 assert (h2 := l109 h0).
 apply t94. refine (subset r12 i9 i29 h1 _) ; finalize. refine (subset r40 i89 i97 h2 _) ; finalize.
Qed.
Definition i98 := makepairF f46 f19.
Notation p142 := (BND r16 i98). (* BND(1 / 6, [0.15625, 0.166667]) *)
Lemma t95 : p142 -> p140 -> p139.
 intros h0 h1.
 refine (sub r16 r39 i98 i96 i95 h0 h1 _) ; finalize.
Qed.
Lemma l112 : s1 -> p139 (* BND(1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)), [0.125, 0.166667]) *).
 intros h0.
 assert (h1 := l22 h0).
 assert (h2 := l113 h0).
 apply t95. refine (subset r16 i12 i98 h1 _) ; finalize. exact h2.
Qed.
Lemma t96 : p122 -> p139 -> p138.
 intros h0 h1.
 refine (mul_op r61 r38 i4 i95 i94 h0 h1 _) ; finalize.
Qed.
Lemma l111 : s1 -> p138 (* BND((float<24,-149,ne>(x * x) - x * x) * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-5.12227e-09, 4.96705e-09]) *).
 intros h0.
 assert (h1 := l103 h0).
 assert (h2 := l112 h0).
 apply t96. exact h1. exact h2.
Qed.
Lemma t97 : p68 -> p138 -> p67.
 intros h0 h1.
 refine (add r58 r60 i46 i94 i45 h0 h1 _) ; finalize.
Qed.
Lemma l56 : s1 -> p67 (* BND(float<24,-149,ne>(x * x) * (float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))) + (float<24,-149,ne>(x * x) - x * x) * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-7.45058e-09, 1.22373e-08]) *).
 intros h0.
 assert (h1 := l57 h0).
 assert (h2 := l111 h0).
...
Qed.
Lemma l55 : s1 -> p66 (* BND(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-7.45058e-09, 1.22373e-08]) *).
 intros h0.
 assert (h1 := l56 h0).
 apply t98. exact h1.
Qed.
...
Qed.
Lemma l50 : s1 -> p60 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) + (float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-1.49012e-08, 1.59626e-08]) *).
 intros h0.
 assert (h1 := l51 h0).
 assert (h2 := l55 h0).
...
Qed.
Lemma l49 : s1 -> p59 (* BND(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))), [-1.49012e-08, 1.59626e-08]) *).
 intros h0.
 assert (h1 := l50 h0).
 apply t100. exact h1.
Qed.
...
Qed.
Lemma l48 : s1 -> p58 (* BND(-(float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-1.59626e-08, 1.49012e-08]) *).
 intros h0.
 assert (h1 := l49 h0).
 apply t101. exact h1.
Qed.
...
Qed.
Lemma l47 : s1 -> p57 (* BND(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-1.59626e-08, 1.49012e-08]) *).
 intros h0.
 assert (h1 := l48 h0).
 apply t102. exact h1.
Qed.
...
Qed.
Lemma l44 : s1 -> p54 (* BND(float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) + (1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))))), [-4.57649e-08, 4.47035e-08]) *).
 intros h0.
 assert (h1 := l45 h0).
 assert (h2 := l47 h0).
...
Qed.
Lemma l43 : s1 -> p53 (* BND(float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880)))), [-4.57649e-08, 4.47035e-08]) *).
 intros h0.
 assert (h1 := l44 h0).
 apply t104. exact h1.
Qed.
...
Qed.
Lemma l42 : s1 -> p52 (* BND(x * (float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - (1 - x * x * (1 / 6 - x * x * (1 / 120 - x * x * (1 / 5040 - x * x / 362880))))), [-3.43237e-08, 3.35276e-08]) *).
 intros h0.
 assert (h1 := l10 h0).
 assert (h2 := l43 h0).
...
Qed.
Lemma l41 : s1 -> p51 (* BND(x * float<24,-149,ne>(1 - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 6) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 120) - float<24,-149,ne>(float<24,-149,ne>(x * x) * float<24,-149,ne>(float<24,-149,ne>(1 / 5040) - float<24,-149,ne>(float<24,-149,ne>(x * x) / 362880)))))))) - Mts, [-3.43237e-08, 3.35276e-08]) *).
 intros h0.
 assert (h1 := l42 h0).
 apply t106. exact h1.
Qed.
